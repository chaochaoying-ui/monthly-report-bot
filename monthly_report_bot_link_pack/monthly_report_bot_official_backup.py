...
# 导入自定义模块
from lark_official_handler import LarkOfficialHandler
...
async def start_official_handler():
    """启动基于官方文档的事件处理"""
    global lark_handler
    
    logger.info("启动基于飞书官方文档的事件处理...")
    
    # 创建官方处理器
    lark_handler = LarkOfficialHandler()
